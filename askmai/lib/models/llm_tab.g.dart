...
LLMTab _$LLMTabFromJson(Map<String, dynamic> json) => LLMTab(
  ...
  customStrategy: json['customStrategy'] as String?,
  customAnswerContentXPath: json['customAnswerContentXPath'] as String?,
...
Map<String, dynamic> _$LLMTabToJson(LLMTab instance) => <String, dynamic>{
  ...
  'customStrategy': instance.customStrategy,
  'customAnswerContentXPath': instance.customAnswerContentXPath,
